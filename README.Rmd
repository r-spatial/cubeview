...
[![cran checks](https://badges.cranchecks.info/worst/cubeview.svg)](https://cran.r-project.org/web/checks/check_results_cubeview.html)
...
Please note that the 'cubeview' project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md). By participating in this project you agree to abide by its terms.
